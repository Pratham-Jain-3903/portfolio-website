...
const experienceData: ExperienceEntry[] = [
  {
    ...
    skills: ['Computer Vision', 'Distributed Training', 'PyTorch', 'AMP', 'Model Evaluation', 'Production ML'],
  },
  {
    ...
    responsibilities: [
      'Reduced Azure DPS provisioning time from 11.3 hours to 32 minutes by resolving a large-scale thundering herd problem; implemented exponential backoff with jitter and idempotent retry logic, cutting retries by 99.8% and achieving 100% provisioning success across millions of devices.',
      'Optimized Cosmos DB (NoSQL) fact & dimension modeling with RU-aware partitioning and removed anti-patterns (duplication, locality issues); built a multi-client fact table and Parquet archival on Blob Storage to lower query latency and RU consumption.',
      'Engineered AI-driven cloud systems by orchestrating adaptive agents, LLMs, and embedding models for IoT data analysis and customer queries; deployed on a Next.js PWA + AKS microservices platform with Redis caching, idempotent workflows, and real-time APIs—delivering 78% lower query latency for 10K+ customers, 30% cost savings, 7% higher satisfaction, and improved downstream accuracy.',
    ],
    skills: ['Azure', 'DPS', 'CosmosDB', 'Parquet', 'Blob Storage', 'Next.js', 'AKS', 'Redis', 'Distributed Systems', 'Embeddings'],
  },
  {
